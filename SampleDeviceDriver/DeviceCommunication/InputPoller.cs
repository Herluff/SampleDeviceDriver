...
namespace SampleDeviceDriver
{
    ...
    public class InputPoller
    {
        ...
        private readonly SampleDeviceDriverConnectionManager _connectionManager;

        public InputPoller(IEventManager eventManager, SampleDeviceDriverConnectionManager connectionManager)
        {
        ...
        public void Start()
        {
            ...
            {
                Name = string.Format(System.Globalization.CultureInfo.InvariantCulture, "SampleDeviceDriver driver listener thread for input events"),
