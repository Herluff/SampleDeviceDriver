...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    public class SampleDeviceDriverDriverDefinition : DriverDefinition
    {
        /// <summary>
        ...
        {
            return new SampleDeviceDriverContainer(this);
        }

        protected override DriverInfo CreateDriverInfo()
        {
            // TODO: Replace values below with values describing your driver.
            return new DriverInfo(Constants.DriverId, "SampleDeviceDriver", "SampleDeviceDriver group", "1.0", new[] { Constants.Product1 });
        }
    }
}
