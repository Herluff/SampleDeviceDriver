...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    public class SampleDeviceDriverPlaybackManager : PlaybackManager
    {
        ...
        public SampleDeviceDriverPlaybackManager(SampleDeviceDriverContainer container) : base(container)
        {
