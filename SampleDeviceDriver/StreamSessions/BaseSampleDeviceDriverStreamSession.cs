...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    internal abstract class BaseSampleDeviceDriverStreamSession : BaseStreamSession
    {
        public Guid Id { get; }
        ...
        protected readonly SampleDeviceDriverConnectionManager _connectionManager;
        ...
        public BaseSampleDeviceDriverStreamSession(ISettingsManager settingsManager, SampleDeviceDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId)
        {
            Id = sessionId;
