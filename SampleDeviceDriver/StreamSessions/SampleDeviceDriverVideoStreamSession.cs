...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    internal class SampleDeviceDriverVideoStreamSession : BaseSampleDeviceDriverStreamSession
    {

        public SampleDeviceDriverVideoStreamSession(ISettingsManager settingsManager, SampleDeviceDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId) :
