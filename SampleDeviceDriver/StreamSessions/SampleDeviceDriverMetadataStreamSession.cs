...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    internal class SampleDeviceDriverMetadataStreamSession : BaseSampleDeviceDriverStreamSession
    {
        public SampleDeviceDriverMetadataStreamSession(ISettingsManager settingsManager, SampleDeviceDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId, int channel) :
