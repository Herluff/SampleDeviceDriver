...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    internal class SampleDeviceDriverMicrophoneStreamSession : BaseSampleDeviceDriverStreamSession
    {
        ...
        public SampleDeviceDriverMicrophoneStreamSession(ISettingsManager settingsManager, SampleDeviceDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId) :
