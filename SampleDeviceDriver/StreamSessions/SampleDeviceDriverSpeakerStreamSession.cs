...
namespace SampleDeviceDriver
{
    ...
    /// </summary>
    internal class SampleDeviceDriverSpeakerStreamSession : BaseSampleDeviceDriverStreamSession
    {
        private byte[] _currentSpeakerData = null;
        private AudioHeader _currentSpeakerHeader = null;

        public SampleDeviceDriverSpeakerStreamSession(ISettingsManager settingsManager, SampleDeviceDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId) :
